        ...
        <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="max-h-[700px] overflow-y-auto">
                    {logs.length === 0 ? (
                        <p className="text-center text-gray-500 py-16 text-lg">No email activity yet. Start a campaign to see logs.</p>
                    ) : (
                        <table className="w-full text-left text-sm whitespace-nowrap">
                            <thead className="bg-gray-50 border-b border-gray-100 uppercase text-xs font-semibold text-gray-500 sticky top-0">
                                <tr>
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {logs.map((log: any) => (
                                    <tr key={log.id} className="hover:bg-blue-50/50 transition-colors">
                                        <td className="px-6 py-4 flex items-center gap-2 font-medium capitalize text-gray-700">
