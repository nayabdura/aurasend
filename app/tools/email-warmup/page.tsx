            ...
            <main className="pt-20">
                ...
                <section className="py-24 bg-slate-50">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <h2 className="text-4xl font-black text-slate-900 mb-4">How Email Warmup Works</h2>
                            <p className="text-xl text-slate-500 max-w-2xl mx-auto">Your sending reputation builds daily, silently, while you focus on what matters.</p>
                        </div>
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={i} className={`bg-white rounded-3xl p-8 border ${step.border} shadow-sm hover:shadow-lg transition-shadow`}>
                ...
                <section className="py-24 bg-white">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                <h2 className="text-4xl font-black text-slate-900 mb-6">Everything you need to build a bulletproof sender reputation</h2>
                            ...
                            <div className="bg-gradient-to-br from-purple-900 to-slate-900 rounded-3xl p-8 text-white">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={row.day} className="flex items-center gap-4 bg-white/5 rounded-xl px-4 py-3 border border-white/10">
                ...
                <section className="py-20 bg-gradient-to-r from-purple-600 to-indigo-600">
                    <div className="max-w-4xl mx-auto px-6 text-center">
                        ...
                        <Link href="/login" className="inline-flex items-center gap-2 h-14 px-8 bg-white text-purple-700 font-bold rounded-full text-base shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all">
