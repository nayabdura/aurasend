            ...
            <main className="pt-32 pb-24 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="text-center max-w-4xl mx-auto mb-20">
                        ...
                        <p className="text-xl text-slate-500 leading-relaxed font-medium">From solo founders to massive agencies, AuraSend provides the architecture to scale your revenue engine without the manual busywork.</p>
                    </div>

                    <div className="grid md:grid-cols-2 gap-8 mb-32">
                        {CASES.map((c, i) => (
                            <div key={i} className="bg-white border border-slate-100 rounded-[2rem] p-10 shadow-xl shadow-slate-200/50 hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden group">
                                ...
                                <div className="flex flex-col sm:flex-row gap-8 relative z-10">
                                    <div className="flex-1">
                                        ...
                                        <p className="text-slate-500 leading-relaxed text-lg mb-8 font-medium">{c.desc}</p>
                                        <ul className="space-y-4">
                                            {c.points.map((p, j) => (
                                                <li key={j} className="flex items-center gap-3 text-base font-semibold text-slate-700">
